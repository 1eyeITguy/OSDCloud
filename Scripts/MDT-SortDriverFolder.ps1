...
$FileToEdit = "E:\MDTProduction\Control\DriverGroups.xml"

#Set the export path where you want the new file to go.
$exportPath = "E:\MDTProduction\Control\DriverGroups.xml"
...
$BackupFolderPath = 'E:\MDTProduction\Control\DriverGroupsBackup\'
